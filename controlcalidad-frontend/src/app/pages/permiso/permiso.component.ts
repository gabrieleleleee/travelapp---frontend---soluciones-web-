...
export class PermisoComponent implements OnInit {
  ...
  protected lista = signal<Permiso[]>([]);
  ...
  constructor() {
    ...
    codigoPermiso: ['', [Validators.required]],
  ...
  guardar(): void {
    ...
    const datos = this.formulario.value as Permiso;
    if (this.editando()) {
  ...
  editar(item: Permiso): void {
    // ✅ signal.set() para actualizar estado de edición
    this.editando.set(true);
    this.idSeleccionado.set((item as any).idPermiso);
