...
export class CategoriaProductoComponent implements OnInit {
  ...
  protected lista = signal<CategoriaProducto[]>([]);
  ...
  guardar(): void {
    ...
    const datos = this.formulario.value as CategoriaProducto;
    if (this.editando()) {
  ...
  editar(item: CategoriaProducto): void {
    // ✅ signal.set() para actualizar estado de edición
    this.editando.set(true);
    this.idSeleccionado.set((item as any).idCategoria);
