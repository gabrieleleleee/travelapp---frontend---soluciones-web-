...
export class MateriaPrimaComponent implements OnInit {
  ...
  protected lista = signal<MateriaPrima[]>([]);
  ...
  guardar(): void {
    ...
    const datos = this.formulario.value as MateriaPrima;
    if (this.editando()) {
  ...
  editar(item: MateriaPrima): void {
    // ✅ signal.set() para actualizar estado de edición
    this.editando.set(true);
    this.idSeleccionado.set((item as any).idMateriaPrima);
